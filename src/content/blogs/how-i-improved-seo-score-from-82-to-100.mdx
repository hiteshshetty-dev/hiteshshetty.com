...
*   `keywords`: A bit old-school, and Google _says_ it doesn't really use <a href='https://developers.google.com/search/blog/2009/09/google-does-not-use-keywords-meta-tag#why-doesnt-google-use-the-keywords-meta-tag' target='_blank' rel='noopener noreferrer'>this</a> for ranking anymore. But it costs nothing to add, and other, smaller search engines might. I just pop in 5-7 relevant terms.
