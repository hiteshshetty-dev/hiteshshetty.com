...
This is where Open Graph (OG) tags come in. These are meta tags created by Facebook/Meta (but used by _everyone_) that control how your link looks when it’s shared. They create the “card” with a title, description, and, most importantly, a preview image.
