...
2. **Automatic Transaction Retries by the MongoDB Driver**
   ...
   (For reference, [here's](https://github.com/mongodb/node-mongodb-native/blob/8cb5cafc36c55ae08bbc506e539494e753e973db/lib/core/sessions.js#L371-L393) the `withTransaction` source code).
