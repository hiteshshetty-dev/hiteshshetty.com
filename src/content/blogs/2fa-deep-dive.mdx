...
<div className="flex flex-col sm:flex-row my-6 justify-center items-center">
    <div className="flex-[0.25]">
        <Image 
            src="/images/blogs/2fa-deep-dive/2fa-setup-qr-code.webp" 
    ...
    <div className="flex-[0.75]">
        <Image 
            src="/images/blogs/2fa-deep-dive/2fa-decoded-details.webp" 
...
![UNIX Time Visualization](/images/blogs/2fa-deep-dive/unix-time.webp)
...
![Time Period Division for OTP Counter](/images/blogs/2fa-deep-dive/unix-to-counter.webp)

We then convert this counter from decimal to hexadecimal and pad it with zeros to make it 16 characters long.

![Hexadecimal Counter Conversion](/images/blogs/2fa-deep-dive/counter-to-decimal.webp)
...
![Secret Key Decoding Process](/images/blogs/2fa-deep-dive/decoding-secret.webp)

Next, we hash the counter with the secret key using the HMAC-SHA1 algorithm, which generates a 40-character output.

![HMAC-SHA1 Hash Generation](/images/blogs/2fa-deep-dive/merging-secret-and-counter.webp)
...
![Dynamic Truncation Offset Calculation](/images/blogs/2fa-deep-dive/offset-calculation.webp)

### Step 3: Extract 8 characters
Take the next 8 characters after this offset and convert them into an unsigned decimal number.

![8-Character Conversion to Decimal](/images/blogs/2fa-deep-dive/hash-to-unsigned-decimal.webp)
...
![Final 6-Digit OTP Generation](/images/blogs/2fa-deep-dive/getting-otp.webp)
